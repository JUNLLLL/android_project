...
public class ShowPasswordText extends EditText implements
    ...
    public ShowPasswordText(Context context) {
        this(context, null);
    }

    public ShowPasswordText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public ShowPasswordText(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        if (mToggleDrawable == null) {
            mToggleDrawable = getResources().getDrawable(R.drawable.password_hide);
        }
        ...
        if (getCompoundDrawables()[2] != null) {
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                if (touchable) {
                    if (!isHide) {
                        //显示密码明文
                        ChangeImage(R.drawable.password_show);
                        ...
                        //隐藏密码明文
                        ChangeImage(R.drawable.password_hide);
    ...
    {
        mToggleDrawable = getResources().getDrawable(id);
        mToggleDrawable.setBounds(0, 0, mToggleDrawable.getIntrinsicWidth(), mToggleDrawable.getIntrinsicHeight());
    }
